...
class UnitTests(unittest.TestCase):
    def setUp(self):
        ...
        self.tri = shape_calculator.Triangle(5, 6)
    ...
    def test_triangle_string(self):
        actual = str(self.tri)
        expected = "Triangle(base=5, t_height=6)"
        self.assertEqual(actual, expected, 'Expected string representation of triangle to be "Triangle(base=5, t_height=6)"')

    def test_t_area(self):
        actual = self.tri.get_t_area()
        expected = 15
        self.assertEqual(actual, expected, 'Expected area of triangle to be 15')    
